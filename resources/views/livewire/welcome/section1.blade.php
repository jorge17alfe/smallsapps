    ...
    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
        ...
        <a href="{{route('login')}}"
            ...
            <div
                ...
                <img src="{{ asset('assets/images/task.jpg') }}" alt="" >
            </div>

            <div class="pt-3 sm:pt-5">
                <h2 class="text-xl font-semibold text-black dark:text-white">Multitask</h2>

                <p class="mt-4 text-sm/relaxed">
                    Aloc Raise helps your company with different tasks managed from a control
                            panel
                </p>
            </div>
